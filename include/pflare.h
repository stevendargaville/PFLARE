...
PETSC_EXTERN PetscErrorCode PCAIRGetPolySparsityOrder(PC, PetscInt *);
...
PETSC_EXTERN PetscErrorCode PCAIRGetCoarsestPolySparsityOrder(PC, PetscInt *);
...
PETSC_EXTERN PetscErrorCode PCAIRSetPolySparsityOrder(PC, PetscInt);
...
PETSC_EXTERN PetscErrorCode PCAIRSetCoarsestPolySparsityOrder(PC, PetscInt);
